...
playlist12Text = font.render('Mon.Mash', True, [0,0,0])
playlist13Text = font.render('Thriller', True, [0,0,0])
playlist14Text = font.render('Halloween', True, [0,0,0])
playlist15Text = font.render('Squid', True, [0,0,0])
playlist16Text = font.render('immabe', True, [0,0,0])
playlist17Text = font.render('CHRIS', True, [0,0,0])
playlist18Text = font.render('MAS', True, [0,0,0])
playlist19Text = font.render('SONGS', True, [0,0,0])
playlist20Text = font.render('NOW', True, [0,0,0])
